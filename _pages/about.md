...
- title: Interests
  ...
  - name: Reinforcement Learning
    detail: LLM post-training, Off-policy RL, Reasoning, Science
  - name: Deep Learning
    detail: Plasticity, Deep RL, Transformers
- title: Education
  id: cv-education
  items:
  - name: PhD in CS
    detail: EPFL | Prof. Caglar Gulcehre
  - name: MSc in CS
    detail: Oxford | Prof. Shimon Whiteson
  - name: BSc in Maths & CS
    detail: École Polytechnique
  - name: Exchange Programs
    detail: U of Toronto | Software Eng <br>Stanford | AI & Entrepreneurship
- title: Experience
  id: cv-experiences
  items:
  ...
  - name: Research Assistant
    detail: Prof. Hess & Blue Brain Project
...
_I am considering full-time positions in Zurich & Paris for winter 2026/2027._
...
I am currently interning at [Meta FAIR](https://ai.meta.com/research/) in Paris, working with [Julia Kempe](https://cims.nyu.edu/~kempe/) and [Rémi Munos](https://scholar.google.com/citations?user=OvKEnVwAAAAJ) on in-context adaptation and asymmetric self-play applied to formal mathematics ([Lean](https://lean-lang.org/)).
...
At École Polytechnique, I was elected in the first board of the [L'ORE](https://programmes.polytechnique.edu/bachelor/vie-sur-le-campus/organisation-etudiante) (2018), the Bachelor's program student society.
